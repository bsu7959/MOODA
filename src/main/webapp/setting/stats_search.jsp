...
<jsp:useBean id="ms" class="com.koreait.mooda.moodcount.moodSearch"></jsp:useBean>
...
ms.setM_idx(String.valueOf(session.getAttribute("m_idx")));
ms.setYear(request.getParameter("year"));
ms.setMonth(request.getParameter("month"));

dto = dao.moodSearch(ms);
            ...
            <div class="content">
                ...
                <div class="content_mainPage">
                    ...
                    <div class="stats_container">
                        <h2 class="title_font_size">감정 통계 - <%=ms.getYear() %>년 <%=ms.getMonth() %>월</h2>
                        <form action="./stats_search.jsp">
                        	<select class="mcSelBox" name="year" style="width: 100px; padding: 5px; border: none; background: rgb(237,237,229)">
