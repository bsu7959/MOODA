            ...
            <div class="content">
                ...
                <div class="content_mainPage">
                    <div class="content_mainPage_mood1box">
                        ...
                        <div class="write_button" id="write_button"><img src="../images/plus-icon.png"></div>
                    </div>
              
                    <div class="diary_mood_button turnoff" id="diary_mood_button">
                        <div class="add_mood">
                        ...
                        <div class="mood_btn" id="mood_btn">
