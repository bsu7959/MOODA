...
<c:set var="commentList" value="${dao.getCommentReport()}" />
		...
		<div class="main_box">
			<div class="manager_menu1">
				...
				<div class="menu1_content">
					...
					<p class="menu1_content_tab" onclick="location.href='../manager_logout.jsp'">관리자 로그아웃</p>
							...
							<tr>
								<form method="post" name="commentForm">
									...
									<td><input type="text" class="manager_form_input"
										...
										readonly="readonly"></td>
									<td><input type="submit" class="manager_form_rep"
										value="답글 보기" formaction="./moodaReply.jsp"></td>
