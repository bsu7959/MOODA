		...
		<div class="main_box">
			...
			<div class="manager_content">
				...
				<div class="content_mainPage manager_main_div">
					...
					<form method="post" action="./not_write_ok.jsp">
						<p><label class="view_label">번호 : </label><input class="view_input2" name="n_idx" value="<%= dto.getN_idx()%>" readonly="readonly"></p>
						<p><label class="view_label">작성자 : </label><input class="view_input2" name="n_writer" value="<%= dto.getN_writer()%>" readonly="readonly"></p>
						<p><label class="view_label">제목 : </label><input type="text" id="title" class="view_input2" maxlength="30" name="n_title" value="<%= dto.getN_title()%>" readonly="readonly"></p>
						<p><label class="view_label">내용 : </label></p>
						<p>
							<textarea name="n_content" cols="150" rows="10" readonly="readonly" style="padding: 10px;"><%=dto.getN_content() %></textarea>
						</p>
						<p>
							<input type="button" value="수정" class="view_btn" onclick="location.href='./not_edit.jsp?n_idx=<%=dto.getN_idx()%>'">
							<input type="button" value="삭제" class="view_btn" onclick="location.href='./not_del.jsp?n_idx=<%=dto.getN_idx()%>'">
