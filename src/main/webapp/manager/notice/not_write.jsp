			...
			<div class="manager_content">
				...
				<div class="content_mainPage manager_main_div">
					...
					<form method="post" action="./not_write_ok.jsp">
						<p><label class="view_label">작성자 : </label><input class="view_input2" name="n_writer" value="관리자"></p>
						<p><label class="view_label">제목 : </label><input type="text" id="title" class="view_input2" maxlength="30" name="n_title"></p>
						<p><label class="view_label">내용 : </label></p>
						<p>
							<textarea name="n_content" cols="150" rows="10" style="padding: 10px;"></textarea>
						</p>
						<p>
