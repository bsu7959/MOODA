...
%>
<c:set var="memberList" value="${dao.getReportList()}" />
				...
				<div class="content_mainPage manager_main_div">
					<div class="searchTap">
						<form action="./mem_search.jsp">
							...
							<input type="button" class="input_report_view_btn" value="신고된 회원보기"
								onclick="location.href='./member_report.jsp'">
						</form>
					</div>
							...
							<tr>
								<form method="post">
									...
									<td><input type="text" class="manager_form_input"
										...
										name="m_regdate"></td>
									<td><input type="text" class="manager_form_input" value="${member.m_report }" readonly="readonly" name="m_report"></td>
