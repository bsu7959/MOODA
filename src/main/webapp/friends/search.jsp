        ...
        <div class="main_box">
            <div class="menu1">
                ...
                <div class="menu1_content">
                    ...
                    <p class="menu1_content_tab "><a href='./friends.jsp' class="title_font_size">FRIENDS</a></p>
                    <p><a href='./friends.jsp' class="sub_menu semi_tit_font_size">친구들</a></p>
                    <p class="sub_menu"><a href='./friends_suggest.jsp' class=" sub_menu semi_tit_font_size">추천</a></p>
                    <p class="menu1_content_tab "><a href=# class="tab_highlighted title_font_size">SEARCH</a></p>
...
<%
					for(DiaryDTO diary : diaryList) {
						...
						int followCheck = 0;
						if(Integer.parseInt(m_idx) == diary.getD_useridx()){
							followCheck = 3;
						}else {
							followCheck = dao.followCheck(m_idx, String.valueOf(diary.getD_useridx()));
						}
...
%>
                    <div class="friends_box">
                        <div class="friends_box_header clear">
                            ...
                            %>
                            <input class="friends_follow" type="button" value="팔로우" onclick="follow(this)" style="visibility: hidden">
                            <input type="hidden" value=<%=m_idx %>>
                            <input type="hidden" name="f_didx" value=<%=diary.getD_useridx() %>>
                            <%
                            	}
