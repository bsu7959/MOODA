        ...
        <div class="main_box">
            <div class="menu1">
                ...
                <div class="menu1_content">
                    ...
                    <p class="sub_menu"><a href='./friends_suggest.jsp' class="tab_highlighted sub_menu semi_tit_font_size">추천</a></p>
...
<%
					for(DiaryDTO diary : diaryList) {
						System.out.println(diary.getD_useridx());
